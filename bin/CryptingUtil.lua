...
local print_debug_messages = true  -- bitch, im not friendly
...
local function keccak(block_size_in_bytes, digest_size_in_bytes, is_SHAKE, message)
    warn("keccak:", block_size_in_bytes, digest_size_in_bytes, message)
